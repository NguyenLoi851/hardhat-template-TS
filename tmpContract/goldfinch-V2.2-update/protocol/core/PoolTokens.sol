...
contract PoolTokens is IPoolTokens, ERC721PresetMinterPauserAutoIdUpgradeSafe {
  ...
  */
  ...
  function balanceOf(
    address owner
  ) public view virtual override(ERC721Upgradeable, IERC721Upgradeable) returns (uint256) {
  ...
  function getApproved(
    uint256 tokenId
  ) public view virtual override(ERC721Upgradeable, IERC721Upgradeable) returns (address) {
    return super.getApproved(tokenId);
  }

  function supportsInterface(
    bytes4 interfaceId
  ) public view virtual override(ERC721PresetMinterPauserAutoIdUpgradeSafe, IERC165Upgradeable) returns (bool) {
  ...
  function isApprovedForAll(
    address owner,
    address operator
  ) public view virtual override(ERC721Upgradeable, IERC721Upgradeable) returns (bool) {
    return super.isApprovedForAll(owner, operator);
  }

  function ownerOf(uint256 tokenId) public view virtual override(ERC721Upgradeable, IERC721Upgradeable) returns(address) {
