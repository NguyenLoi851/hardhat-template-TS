...
contract SeniorPool is BaseUpgradeablePausable, ISeniorPool {
  ...
  function deposit(uint256 amount) public override whenNotPaused nonReentrant returns (uint256 depositShares) {
    ...
    console.log("contract senior pool deposit");
    ...
    console.log("potentialNewTotalShares", potentialNewTotalShares);
  ...
  function sharesWithinLimit(uint256 _totalShares) internal view returns (bool) {
    console.log("\ncontract senior pool sharesWithinLimit");
    console.log("_totalShares.mul(sharePrice).div(fiduMantissa())", _totalShares.mul(sharePrice).div(fiduMantissa()));
    console.log("config.getNumber(uint256(ConfigOptions.Numbers.TotalFundsLimit))", config.getNumber(uint256(ConfigOptions.Numbers.TotalFundsLimit)));
    console.log("usdcToFidu(config.getNumber(uint256(ConfigOptions.Numbers.TotalFundsLimit)))", usdcToFidu(config.getNumber(uint256(ConfigOptions.Numbers.TotalFundsLimit))));
    console.log("/contract senior pool sharesWithinLimit\n");
    return
