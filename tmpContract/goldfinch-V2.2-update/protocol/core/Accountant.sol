...
library Accountant {
  ...
  function calculateInterestAccruedOverPeriod(
    ...
    console.log("\ncontract accountant calculateInterestAccruedOverPeriod");
    console.log("endTime", endTime);
    console.log("startTime", startTime);
    console.log("secondsElapsed", secondsElapsed);
    console.log("balance", balance);
    uint256 totalInterestPerYear = balance.mul(cl.interestApr()).div(INTEREST_DECIMALS);
    console.log("totalInterestPerYear", totalInterestPerYear);
    ...
    console.log("interestOwed", interestOwed);
    console.log("/contract accountant calculateInterestAccruedOverPeriod\n");
    return interestOwed;
  }
  ...
  function allocatePayment(
  ...
  ) public view returns (PaymentAllocation memory) {
    console.log("\ncontract accountant allocatePayment");
    ...
    console.log("additionalBalancePayment", additionalBalancePayment);
    console.log("/contract accountant allocatePayment\n");
