...
contract TranchedPool is BaseUpgradeablePausable, ITranchedPool, SafeERC20Transfer {
  ...
  function collectInterestAndPrincipal(
    ...
    console.log("\ncontract tranchedPool collectInterestAndPrinciple");
    ...
    console.log("reserveFeePercent", reserveFeePercent);
    console.log("interest", interest);
    console.log("principal", principal);
    console.log("totalDeployed", totalDeployed);
    console.log("juniorFeePercent", juniorFeePercent);
    ...
    console.log("result.reserveDeduction", result.reserveDeduction);
    console.log("result.interestRemaining", result.interestRemaining);
    console.log("result.principalRemaining", result.principalRemaining);
    ...
    console.log("totalReserveAmount", totalReserveAmount);
    sendToReserve(totalReserveAmount);
    console.log("/contract tranchedPool collectInterestAndPrinciple\n");
  ...
  function _assess() internal {
    ...
    console.log("\ncontract tranchedPool assess");
    console.log("interestAccrued1", interestAccrued);
    ...
    console.log("interestAccrued2", interestAccrued);
    ...
    for (uint256 i = 0; i < poolSlices.length; i++) {
      ...
      console.log("interestAccrued3", interestAccrued);
      console.log("poolSlices[i].principalDeployed", poolSlices[i].principalDeployed);
      console.log("totalDeployed", totalDeployed);
      console.log("interestForSlide", interestForSlice);
      ...
      console.log("poolSlices[i].principalDeployed", poolSlices[i].principalDeployed);
      console.log("totalDeployed", totalDeployed);
      console.log("principalPaymentsPerSlice[i]", principalPaymentsPerSlice[i]);
      poolSlices[i].totalInterestAccrued = poolSlices[i].totalInterestAccrued.add(interestForSlice);
      console.log("poolSlices[i].totalInterestAccrued", poolSlices[i].totalInterestAccrued);
    }
    ...
    if (interestPayment > 0 || principalPayment > 0) {
      ...
      console.log("interestPayment1", interestPayment);
    ...
    console.log("/contract tranchedPool assess\n");
