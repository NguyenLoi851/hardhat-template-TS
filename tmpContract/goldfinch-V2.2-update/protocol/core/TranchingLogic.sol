...
library TranchingLogic {
  ...
  function calculateExpectedSharePrice(
    ...
    console.log("\ncontract TranchingLogic calculateExpectedSharePrice");
    console.log("amount", amount);
    console.log("tranche.principalDeposited", tranche.principalDeposited);
    console.log("sharePrice", sharePrice);
    console.log("/contract TranchingLogic calculateExpectedSharePrice\n");
  ...
  function getTotalInterestAndPrincipal(
    ...
    console.log("\ncontract TranchingLogic getTotalInterestAndPrincipal");
    principalAccrued = creditLine.principalOwed();
    console.log("principalAccrued", principalAccrued);
    ...
    console.log("principalAccrued", principalAccrued);
    console.log("slice.totalInterestAccrued", slice.totalInterestAccrued);
    console.log("/contract TranchingLogic getTotalInterestAndPrincipal\n");
  ...
  function applyToAllSeniorTranches(
    ...
    console.log("\ncontract TranchingLogic applyToAllSeniorTranches");
    ...
    for (uint256 i = 0; i < poolSlices.length; i++) {
      ...
      console.log("sliceInfo.reserveFeePercent", sliceInfo.reserveFeePercent);
      console.log("sliceInfo.interestAccrued", sliceInfo.interestAccrued);
      console.log("sliceInfo.principalAccrued", sliceInfo.principalAccrued);
      ...
      console.log("scaleForSlice(poolSlices[i], interest, totalDeployed)", scaleForSlice(poolSlices[i], interest, totalDeployed));
      console.log("scaleForSlice(poolSlices[i], principal, totalDeployed)", scaleForSlice(poolSlices[i], principal, totalDeployed));
      ...
      console.log("seniorApplyResult.interestRemaining", seniorApplyResult.interestRemaining);
      console.log("applyResult.interestRemaining", applyResult.interestRemaining);
      console.log("seniorApplyResult.principalRemaining", seniorApplyResult.principalRemaining);
      console.log("applyResult.principalRemaining", applyResult.principalRemaining);
      console.log("seniorApplyResult.reserveDeduction", seniorApplyResult.reserveDeduction);
      console.log("applyResult.reserveDeduction", applyResult.reserveDeduction);
    ...
    console.log("/contract TranchingLogic applyToAllSeniorTranches\n");
  ...
  function applyToSeniorTranche(
    ...
    console.log("\ncontract TranchingLogic applyToSeniorTranche");
    console.log("interestRemaining", interestRemaining);
    console.log("principalRemaining", principalRemaining);
    console.log("sliceInfo.interestAccrued", sliceInfo.interestAccrued);
    console.log("sliceInfo.principalAccrued", sliceInfo.principalAccrued);
    console.log("sliceInfo.reserveFeePercent", sliceInfo.reserveFeePercent);
    ...
    console.log("expectedInterestSharePrice", expectedInterestSharePrice);
    ...
    console.log("expectedPrincipalSharePrice", expectedPrincipalSharePrice);
    ...
    console.log("desiredNetInterestSharePrice", desiredNetInterestSharePrice);
    ...
    console.log("reserveDeduction", reserveDeduction);
    ...
    console.log("/contract TranchingLogic applyToSeniorTranche\n");
    return
