...
contract CreditLine is BaseUpgradeablePausable, ICreditLine {
    ...
    )
  {
    ...
    console.log("timeToAssess", timeToAssess);
    ...
    console.log("/contract creditLine assess\n");
  ...
  function _isLate(uint256 timestamp) internal view returns (bool) {
    ...
    console.log("contract creditLine");
    console.log(timestamp);
    console.log(lastFullPaymentTime);
    console.log(secondsElapsedSinceFullPayment);
    console.log(paymentPeriodInDays.mul(SECONDS_PER_DAY));
    console.log(balance);
    console.log("/contract creditLine");
  ...
  {
    console.log("\ncontract creditLine handlePayment");
    (uint256 newInterestOwed, uint256 newPrincipalOwed) = updateAndGetInterestAndPrincipalOwedAsOf(timestamp);
    console.log("newInterestOwed", newInterestOwed);
    console.log("newPrincipalOwed", newPrincipalOwed);
    ...
    console.log("newInterestOwed", newInterestOwed);
    console.log("newPrincipalOwed", newPrincipalOwed);
    console.log("pa.interestPayment", pa.interestPayment);
    console.log("pa.principalPayment", pa.principalPayment);
    ...
    console.log("/contract creditLine handlePayment\n");
